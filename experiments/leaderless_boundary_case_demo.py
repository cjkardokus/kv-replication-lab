...
mask -- see docs/AUDIT_FINDINGS.md's §2 and docs/results.md's
"Demonstrating the W+R boundary case" section for the full writeup this
...
What was tried (see docs/results.md for the full table of runs)
------------------------------------------------------------------
